...
<div class="container">
<h2 class="heading text-capitalize mb-sm-5 mb-4"> Bill Received </h2>
<?php
 $query_search = "SELECT * FROM bill WHERE status = '1'";
  ...
  <table class="table table-hover">
    ...
    <?php
   	   if(mysqli_num_rows($result_search)==0){
            ...
            $query7 = "SELECT * FROM  bill WHERE student_roll_no = '$student_roll_no'";
