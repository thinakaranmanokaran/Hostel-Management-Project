    ...
    <div class="container">
        <div class="mail_grid_w3l">
            <form action="" method="post">
                <div class="row">
                    <div class="col-lg-6">
                        <h2 class="heading text-capitalize mb-sm-5 mb-4">Search By Date</h2>
                        <input type="text" name="sdate" value="<?php echo $rdate; ?>">
                    </div>
               </div>
               <br>
...
<?php
   if (isset($_POST['search'])) {
   	   ...
   	   $query_search = "SELECT * FROM s_attendance WHERE rdate like '%$sdate%'";
    ...
    <?php
   	   if(mysqli_num_rows($result_search)==0){
			...
			?>
      		...
      		<tr><td><?php echo $student_name;?></td><td><?php echo $row_search['student_roll_no'];?></td><td><?php echo $row_search['a_status'];?></td>
		  </tr>
			<?php
		  }
		  ?>
