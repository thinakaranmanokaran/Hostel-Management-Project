...
<?php
    ...
    <div class="container">
      <div class="card">
      <div class="card-header">Subject:<b><?php echo $row['subject_h']; ?></b></div>
      <div class="card-body">Message:<?php echo $row['message']; ?></div> 
      <div class="card-footer">Roll No:<?php echo $row['sender_id'] ?><span style="float: right">Date:<?php echo $row['msg_date']." ".$row['msg_time']; ?></span></div>
  </div>
</div>
<br><br>
