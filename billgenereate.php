...
<?php
 $query_search = "SELECT * FROM room WHERE Allocated = '1'";
  ...
  <table class="table table-hover">
    ...
    <?php
   	   if(mysqli_num_rows($result_search)==0){
			...
			<td><a class="btn btn-primary" href="gen.php?student_roll_no=<?php echo $row_search['student_roll_no'];?>">Bill Generate</a></td>
           </tr>
			<?php
		  }
		  ?>
