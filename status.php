...
<div class="container">
<h2 class="heading text-capitalize mb-sm-5 mb-4">In/Out Entry Status</h2>
<?php
 $query_search = "SELECT * FROM student_monitor";
    ...
    <?php
   	   if(mysqli_num_rows($result_search)==0){
			...
			?>
      		...
      		<tr><td><?php echo $full;?></td><td><?php echo $row_search['student_roll_no'];?></td>
			<td><?php echo $row_search['status'];?>
            <td><?php echo $row_search['reason'];?>
            <td><?php echo $row_search['rdate'];?>
           </tr>
			<?php
		  }
		  ?>
