...
if(isset($btn))
{
		...
		$uqry="insert into bill(student_roll_no,student_name,Hostel_Name,Room_No,hostel_fees,mess_fees,total,status,rdate) values('$student_roll_no','$student_name','$Hostel_Name','$Room_No','$hostel_fees','$mess_fees','$total','0','$rdate')";
echo "insert into bill(student_roll_no,student_name,Hostel_Name,Room_No,hostel_fees,mess_fees,total,status,rdate) values('$student_roll_no','$student_name','$Hostel_Name','$Room_No','$hostel_fees','$mess_fees','$total','0','$rdate')";
...
<script>
    ...
    window.location.href="billgenereate.php";
</script>
<?php
		}
		else
	...
	<div class="container">
			<div class="mail_grid_w3l">
				<form action="" method="post">
					<div class="row">
					        <div class="col-md-9"> 
							<input type="text" placeholder="Hostel Fees" name="hostel_fees" required>
							</div>
                            
                            <div class="col-md-9"> 
							<input type="text" placeholder="Mess Fees" name="mess_fees" required>
							</div>
							<div class="col-md-9"> 
							<input type="text" placeholder="Total Fees" name="total" required>
							</div>
                            
                            <div class="col-md-9"> 
							<input type="text" placeholder="Hostel id" name="Hostel_id" value="<?php echo $Hostel_Name;?>" readonly>
							</div>
                            <div class="col-md-9"> 
							<input type="text" placeholder="Room No" name="Room_No" required>
							</div>
							<div class="col-md-3">
							<input type="submit" value="Bill Generate" name="btn">
							</div>
					</div>
				</form>
			</div>
