...
session_start();
  ...
  $q = "SELECT * FROM staff WHERE idno = '$idno'";
  $re = mysqli_query($conn,$q);
  $r = mysqli_fetch_assoc($re);
  $staff= $r['Fname']." ".$r['Lname'];
  $rdate=date("Y/m/d");
if(isset($btn))
{

	
		$uqry="insert into srequest(student_roll_no,student_name,Room_No,staff,status,rdate) values('$student_roll_no','$student_name','$Room_No','$staff','0','$rdate')";
		echo "insert into srequest(student_roll_no,student_name,Room_No,staff,status,rdate) values('$student_roll_no','$student_name','$Room_No','$staff','0','$rdate')";
			...
			<div class="mail_grid_w3l">
				<form action="" method="post">
					<div class="row">
                            ...
                            <div class="col-md-9"> 
							<input type="text" placeholder="Room id" name="student_name"  value="<?php echo $row_search['student_name'];?>" readonly>
							</div>
                            <div class="col-md-9"> 
							<input type="text" placeholder="Room id" name="Room_No" value="<?php echo $row_search['Room_No'];?>" readonly>
							</div>

                           
							<div class="col-md-3">
							<input type="submit" value="Request" name="btn">
							</div>
					</div>
				</form>
			</div>
