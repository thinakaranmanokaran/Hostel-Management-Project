...
if(isset($_POST['login-submit'])){
    ...
    $pwd=$_POST['pwd'];
    $s= "select * from  student where student_roll_no='$student_roll_no' and pwd= '$pwd'";   
   $qu= mysqli_query($conn, $s);
   if(mysqli_num_rows($qu)>0){
      $f= mysqli_fetch_assoc($qu);
	  $_SESSION['student_roll_no']=$student_roll_no;
...
<body>
    ...
    <div class=" w3l-login-form">
        ...
        <p class=" w3l-register-p">Login as <a href="parent.php" class="parent">Parent</a></p>
