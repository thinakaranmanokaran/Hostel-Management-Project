					...
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							<div class="contact-fields-w3ls">
								<input type="text" name="Name" placeholder="Name" value="<?php echo $f['Fname']." ".$f['Lname']; ?>" required="" disabled="disabled">
							</div>
							<div class="contact-fields-w3ls">
								<input type="text" name="student_roll_no" placeholder="Roll Number" value=" <?php echo $f['student_roll_no']; ?>" required="" disabled="disabled">
							</div>
							<div class="contact-fields-w3ls">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="index.php" target="_blank"><span class="display"> HMS</span></a>
		</div>
...
<?php
   ...
   if(isset($_POST['submit'])){
     ...
     $query_imp = "SELECT * FROM Student WHERE student_roll_no = '$student_roll_no'";
     ...
     $query_imp2 = "SELECT * FROM Application WHERE student_roll_no = '$student_roll_no'";
     $result_imp2 = mysqli_query($conn,$query_imp2);
     if(mysqli_num_rows($result_imp2)==0){


     $query = "SELECT * FROM Student WHERE student_roll_no = '$student_roll_no'";
     $result = mysqli_query($conn,$query);
            ...
            $query3 = "INSERT INTO Application (student_roll_no,Hostel_id,Application_status,Message) VALUES ('$student_roll_no','$hostel_id',true,'$message')";
