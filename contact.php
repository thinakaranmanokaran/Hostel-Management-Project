	  ...
	  ?>
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="name" placeholder="Name" value="<?php echo $f['Fname']." ".$f['Lname']; ?>" required="">
							</div>
							<div class="contact-fields-w3ls">
								<input type="text" name="rol_no" placeholder="Roll Number" value="<?php echo $_SESSION['student_roll_no']; ?>" required="">
							</div>
							<div class="contact-fields-w3ls">
...
if(isset($_POST['submit'])){
	...
	$query = "INSERT INTO Message (sender_id,receiver_id,hostel_id,subject_h,message,msg_date,msg_time) VALUES ('$student_roll_no','$hos_man_user','$hostel_id','$subject','$message','$today_date','$time')";
