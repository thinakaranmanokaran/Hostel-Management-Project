...
<?php
      ...
      $full=$r['Fname']. $r['Lname'];
		  ...
		  <td>
            ...
            {
                ?>
             <a href="requestview3.php?act=1&id=<?php echo $r1['id'];?>">Approve</a>
             <?php
...
extract($_REQUEST);
if($act==1){
    $up=mysqli_query($connect,"update leave_apply set status='3' where id='$id'");
    if($up){
        ?>
        <script>
            alert("Leave Request Approved")
            window.location.href="requestview3.php";
        </script>
        <?php
    }
}
