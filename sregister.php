...
if (isset($_POST['signup-submit'])) {
  ...
  $i="insert into staff(idno,Fname,Lname,Mob_no,Dept,Pwd,rdate)value('$idno','$Fname','$Lname','$Mob_no','$Dept','$Pwd','$rdate')";
...
<body>
    ...
    <div class=" w3l-login-form">
        ...
        <form action="1.php" method="POST">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="idno" placeholder="Staff Id Card Number" required="required" />
                </div>
            </div>
            <div class=" w3l-form-group">
        ...
        <p class=" w3l-register-p">Already a member?<a href="slogin.php" class="register"> Login</a></p>
    </div>
    <footer>
